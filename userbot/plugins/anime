...
__HELP__ = """
Ricevi informazioni circa anime.

──「 **Anime** 」──
-> `anime <anime>`
Fornisce informazioni circa un anime.

──「 **Character** 」──
-> `character <character>`
Fornisce informazioni circa un personaggio.

──「 **Manga** 」──
-> `manga <manga>`
Fornisce informazioni circa un manga.

──「 **Airing** 」──
-> `airing <anime>`
Fornisce il tempo airing di un anime.
...
@bot.on(dev_cmd(pattern="airling ?(.*)"))
...
@bot.on(dev_cmd(pattern="character ?(.*)"))
